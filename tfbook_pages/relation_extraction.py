# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/lib_relation_extraction.ipynb (unless otherwise specified).

__all__ = ['Relation', 'RelationCollection', 'construct_text_spans', 'extract_relations', 'get_relation_spans',
           'get_verbs', 'find_nearest_pattern', 'merge_overlapping_consecutive_word_span', 'find_latest_span',
           'find_earliest_span', 'find_longest_span']
